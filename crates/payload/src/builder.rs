...
#[derive(Debug, Clone)]
pub struct FraxtalPayloadBuilder<Pool, Client, EvmConfig, N: NodePrimitives, Txs = ()> {
...
impl<Pool, Client, EvmConfig, N: NodePrimitives> FraxtalPayloadBuilder<Pool, Client, EvmConfig, N> {
...
impl<Pool, Client, EvmConfig, N: NodePrimitives, Txs>
    FraxtalPayloadBuilder<Pool, Client, EvmConfig, N, Txs>
{
    ...
    pub fn with_transactions<T>(
        self,
        best_transactions: T,
    ) -> FraxtalPayloadBuilder<Pool, Client, EvmConfig, N, T> {
        let Self {
            pool,
            client,
...
impl<Pool, Client, EvmConfig, N, T> FraxtalPayloadBuilder<Pool, Client, EvmConfig, N, T>
where
...
impl<Pool, Client, EvmConfig, N, Txs> PayloadBuilder
    for FraxtalPayloadBuilder<Pool, Client, EvmConfig, N, Txs>
where
